...
def init_distributed_mode(args):
    ...
    # elif "SLURM_PROCID" in os.environ and not os.environ["SLURM_JOB_PARTITION"] == "interactive":
    #     print("Using slurm mode")

    #     print(f"rank: {int(os.environ['SLURM_PROCID'])}")
...
#         args.gpu = int(os.environ["LOCAL_RANK"])
#     else:
#         raise ValueError("Problem in distributed setup")
